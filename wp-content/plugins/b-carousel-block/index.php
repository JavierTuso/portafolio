...
if ( function_exists( 'bicb_fs' ) ) {
    ...
    define( 'BICB_VERSION', ( isset( $_SERVER['HTTP_HOST'] ) && 'localhost' === $_SERVER['HTTP_HOST'] ? time() : '1.0.8' ) );
    ...
    if ( BICB_HAS_PRO ) {
        if ( function_exists( 'bicb_fs' ) ) {
            bicb_fs()->add_filter( 'freemius_pricing_js_path', function () {
                return BICB_DIR_PATH . 'inc/freemius-pricing/freemius-pricing.js';
            } );
        }
    }
    ...
    require_once BICB_DIR_PATH . '/inc/CustomPost.php';
    require_once BICB_DIR_PATH . '/inc/pattern.php';
    require_once BICB_DIR_PATH . '/inc/HelpPage.php';
    if ( BICB_HAS_FREE ) {
        require_once BICB_DIR_PATH . '/inc/UpgradePage.php';
    }
    class BICBPlugin {
